  ...
  return (
    <header className="z-50 fixed select-none top-0 left-0 w-screen flex h-[80px] justify-between">
      <div
        ...
        style={{ background: "linear-gradient(to right, rgba(255, 193, 7, 1) 30%, rgba(255, 193, 7, 0) 100%)" }}
      >
      ...
      <div className="h-full flex">
        ...
        />
        <div className="opacity-100 bg-black px-14 flex items-center justify-around h-full gap-4">
